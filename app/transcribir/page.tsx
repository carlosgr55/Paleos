    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 text-gray-800 font-sans">
      ...
      <main className="pt-32 px-6 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Botón de Encuesta - Solo aparece cuando hay transcripción */}
          {transcribedText && (
            <div className="flex justify-center mt-8">
              <Link href="https://forms.gle/KTdp9bKjmLpFAwfn9" className="no-underline">
                <button className="bg-amber-700 hover:bg-amber-800 text-white px-10 py-4 rounded-full text-lg font-bold transition-all hover:scale-105 shadow-lg shadow-amber-400 flex items-center gap-3">
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  Ayúdanos respondiendo una encuesta
                </button>
              </Link>
            </div>
          )}
